...
float * new_random_float_array(int size) {
  int range = 1024;
  int is_signed = 1;
...
void gen_test_arrays(float ** out_correct, float ** out_vectorized,
  ...
  *b = new_random_float_array(size);
  *c = new_random_float_array(size);
}
...
void test_routine1() {
  ...
  float * a = new_random_float_array(size);
  float * b = new_random_float_array(size);
...
void test_routine3() {
  int size = get_random(2048, 0) + 10; // get a random size > 10
  float * out_correct = new_random_float_array(size);
